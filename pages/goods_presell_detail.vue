          ...
          <div class="text-wrapper">
            ...
            <div class="acea-row row-middle money-wrapper">
              <div class="money-wrap">
                ...
                <span class="start-time" v-if="presale_pay_status === 1">
                  开售时间: {{ storeInfo.start_time }}
                </span>
              </div>
            ...
            <div class="button-wrapper">
              <button
                ...
                class="btn"
                :disabled="presale_pay_status === 1 || presale_pay_status === 3"
              >
                {{ presale_pay_status === 1 ? "未开始" : "已结束" }}
              </button>
              <!-- <button
                v-else-if="pay_status === 3"
                class="btn"
                :disabled="!stock || pay_status !== 2"
              >
                已结束
              </button> -->
              <button v-else class="btn cart" @click="buy(1, $event)">
                立即预订
              </button>
            </div>
          </div>
...
export default {
  ...
  async asyncData({ app, query }) {
    ...
    return {
      ...
      presale_pay_status: detail.data.presale_pay_status, // 1未开始;2进行中;3已结束
